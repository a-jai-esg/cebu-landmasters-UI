...
const PieChartModal: React.FC<PieChartModalProps> = ({ open, onClose, pieData, title }) => {
    return (
      <Modal open={open} onClose={onClose}>
        ...
        >
          <Card sx={{ width: "70%", maxHeight: "90vh", overflow: "auto", borderRadius: 3, boxShadow: 6, position: "relative" }}>
            <CardContent>
              <IconButton
                aria-label="close"
                onClick={onClose}
